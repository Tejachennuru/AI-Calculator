...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        f"You have been given an image that may contain diagrams, mathematical expressions, equations, graphical problems, or even real-world objects (like home, hat, classroom, man, bottle, etc.). Your task is to analyze the image and return the correct interpretation or solution. "
        f"Note: If the image contains a mathematical expression, equation, or graphical math problem, always use the PEMDAS rule for solving expressions. PEMDAS stands for the Priority Order: Parentheses, Exponents, Multiplication and Division (from left to right), Addition and Subtraction (from left to right). Parentheses have the highest priority, followed by Exponents, then Multiplication and Division, and lastly Addition and Subtraction. "
        f"For example: "
        f"Q. 2 + 3 * 4 "
        f"(3 * 4) => 12, 2 + 12 = 14. "
        f"Q. ∫x^2 "
        ...
        f"YOU CAN HAVE SIX TYPES OF CASES IN THIS IMAGE, AND ONLY ONE CASE SHALL APPLY EVERY TIME: "
        ...
        f"6. Identifying Real-World Objects in the image, such as a home, hat, classroom, man, bottle, car, tree, etc. In this case, the output should also follow the format of a LIST OF ONE DICT [{{'expr': 'object in image', 'result': 'identified object'}}]. "
        f"Analyze the equation, expression, drawing, or object in this image and return the answer according to the given rules: "
